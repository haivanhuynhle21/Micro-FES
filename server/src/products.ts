...
const products: Product[] = [
  {
    id: 1,
    name: 'Frustration Denim Jacket (Medium Wash)',
    price: 5.99,
    description: 'A wheel fidget spinner that spins wheels',
    image: 'http://localhost:8080/denim_jacket.jpg',
    longDescription:
  ...
  {
    id: 2,
    name: 'Frustration Denim Pants (Medium Wash)',
    price: 8.99,
    description: 'A solid steel of rainbow fidget spinning goodness.',
    image: 'http://localhost:8080/denim_pants.jpg',
    longDescription:
  ...
  {
    id: 3,
    name: 'Flower Child Hockey Jersey (Black)',
    price: 7.99,
    description: 'A winged dragon of a spinner.',
    image: 'http://localhost:8080/hocket_jersey.jpg',
    longDescription:
  ...
  {
    id: 5,
    name: 'Shmoody Polar Fleece Quilted Reversible Jacket (Clay/Purple)',
    price: 7.99,
    description: 'Flaming rainbow fun for all ages.',
    image: 'http://localhost:8080/jacket.jpg',
    longDescription:
  ...
  {
    id: 6,
    name: 'Nermby Basketball Jersey (Black)',
    price: 6.99,
    description: 'Jammin this rainbow inspired spinner is so much fun!',
    image: 'http://localhost:8080/jersey.jpg',
    longDescription:
  ...
  {
    id: 7,
    name: 'Memory Bank Hoodie (Ash Heather)',
    price: 8.99,
    description: 'So golden, so spinny! Classic and beautiful.',
    image: 'http://localhost:8080/memory_bank_hoodie.jpg',
    longDescription:
  ...
  },
  {
    ...
    image: 'http://localhost:8080/super_sanerm_coach_jacket.jpg',
    longDescription:
  ...
  {
    id: 9,
    name: 'Nermby Basketball Shorts (Black)',
    price: 8.99,
    description: "So much love in a spinner, it's all rainbows and hearts.",
    image: 'http://localhost:8080/Holiday21-Hovers.jpg',
    longDescription:
  ...
  {
    id: 10,
    name: 'OG Prisma Sweatshorts (Rainbow X Dye)',
    price: 9.99,
    description: 'Sleek and beautiful, this spinner is so fast.',
    image: 'http://localhost:8080/Holiday21-Hovers_0059_027A0547_1024x1024.jpg',
    longDescription:
  ...
  {
    id: 11,
    name: 'Master Nermal San Long Sleeve (Black Lightning Wash)',
    price: 12.99,
    description:
      'So many gears and so little time. You will be endlessly fascinated by this spinner.',
    image:
      'http://localhost:8080/finishedholiday21l_s_0026_KK2A7101_1024x1024.jpg',
    longDescription:
